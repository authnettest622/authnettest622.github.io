...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__modules_analytics_v1_components_inbox_tableauinbox_component__ = __webpack_require__("./src/app/modules/analytics/v1/components/inbox/tableauinbox.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_search_tableausearch_component__ = __webpack_require__("./src/app/modules/analytics/v1/components/search/tableausearch.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__service_data_service__ = __webpack_require__("./src/app/modules/analytics/v1/service/data.service.ts");
...
var AnalyticsRoutes = [
    ...
    { path: 'tableauinbox', component: __WEBPACK_IMPORTED_MODULE_9__modules_analytics_v1_components_inbox_tableauinbox_component__["a" /* TableauInboxComponent */] },
    ...
    { path: 'tableaualert', component: __WEBPACK_IMPORTED_MODULE_10__components_search_tableausearch_component__["a" /* TableauSearchComponent */] },
    ...
    AnalyticsModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["J" /* NgModule */])({
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_4__angular_http__["b" /* HttpModule */], __WEBPACK_IMPORTED_MODULE_6__sharedModule_v1_sharedComponent_module__["a" /* SharedComponentModule */], __WEBPACK_IMPORTED_MODULE_12__angular_common_http__["b" /* HttpClientModule */],
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_7__models_static_model__["b" /* StaticDataSource */], __WEBPACK_IMPORTED_MODULE_11__service_data_service__["a" /* DataService */], { provide: __WEBPACK_IMPORTED_MODULE_3__angular_common__["a" /* APP_BASE_HREF */], useValue: '/' }],
...
/***/ "./src/app/modules/analytics/v1/components/inbox/tableauinbox.component.html":
/***/ (function(module, exports) {
...
/***/ "./src/app/modules/analytics/v1/components/inbox/tableauinbox.component.scss":
/***/ (function(module, exports) {
...
/***/ "./src/app/modules/analytics/v1/components/inbox/tableauinbox.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var TableauInboxComponent = (function () {
    ...
    TableauInboxComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            ...
            template: __webpack_require__("./src/app/modules/analytics/v1/components/inbox/tableauinbox.component.html"),
            styles: [__webpack_require__("./src/app/modules/analytics/v1/components/inbox/tableauinbox.component.scss")]
        }),
        __metadata("design:paramtypes", [])
...
var TableauViewComponent = (function () {
    function TableauViewComponent(http, router, activatedRouter, httpclient) {
        this.http = http;
        this.router = router;
    ...
    TableauViewComponent.prototype.ngOnInit = function () {
        var tableauTicketKey = 'ticket';
        var reportPathKey = 'reportPath';
        this.tabticket = this.getQueryParamValue(tableauTicketKey);
        console.log("tabticket" + this.tabticket);
        this.embeddedAnalyticsReportsPath = this.getQueryParamValue(reportPathKey);
        // let baseAddress = 'https://pnrstage.ic3.com:4443/mobileApp/'
    };
    // getFoods(): string {
    //   // return this.httpclient.get('http://localhost:12838/api/values');
    //   var resp;
    //   this.httpclient.get('http://localhost:12838/api/values')
    //     .subscribe(result => {
    ...
    TableauViewComponent.prototype.ngAfterViewInit = function () {
        ...
        //     }
        //   };
        //   // let postTablueaUIcontext = '?:embed=n&:linktarget=_parent&:embed=y&:showVizHome=n&:apiID=host0';
        //   let embeddedAnalytics = 'embeddedAnalytics/trusted/';
        //   //let vizURL = "https://pnrstage.ic3.com:4443/mobileapp/" + embeddedAnalytics + this.tabticket + this.embeddedAnalyticsReportsPath + postTablueaUIcontext
        //   console.log(" this.embeddedAnalyticsReportsPath"+ this.embeddedAnalyticsReportsPath);
        // //   let embeddedAnalytics = 'embeddedAnalytics/trusted/';
        // //  let postTablueaUIcontext = '?:embed=n&:linktarget=_parent&:embed=y&:showVizHome=n&:apiID=host0';
        //      this.embeddedAnalyticsReportsPath='/t/MMR/views/SampleMerchantAggregatedAccountInsights20170822/Title';
        //   this.tabticket='TYrHRk5gRcWdfRUSsgpJrg==:l_WzfrEkKWhwXRx8Da0xdJpv';
        //   this.vizUrl = "https://pnrstage.ic3.com:4443/mobileapp/" + embeddedAnalytics + this.tabticket + this.embeddedAnalyticsReportsPath;
        //   new tableau.Viz(document.getElementById(this.visIndex), this.vizUrl, optionsOne);
    };
    TableauViewComponent.prototype.getQueryParamValue = function (key) {
    ...
    TableauViewComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Http */], __WEBPACK_IMPORTED_MODULE_2__angular_router__["b" /* Router */], __WEBPACK_IMPORTED_MODULE_2__angular_router__["a" /* ActivatedRoute */], __WEBPACK_IMPORTED_MODULE_3__angular_common_http__["a" /* HttpClient */]])
...
module.exports = "<!--<div class=\"container\" style=\"max-width:750px;margin-left:20px;margin-top:-300px;margin-right:20px;margin-bottom: 5px;\">\r\n   <div class=\"row\">\r\n      <nav class=\"navbar\" style=\"margin-right:10px;float:right;margin-top:-30px;\">\r\n            <ul class=\"nav navbar-nav\" style=\"margin-right:-10px;float:right;margin-top:0px;\">\r\n                <li><a class ='btn'  (click)='viewAlert()' style=\"margin-right:-5px;float:right; font-style: normal;font-size: 8pt;margin-top:15px;\"><i   (click)='newfeed()' style=\"cursor: pointer\"></i><br /> <u>View Alert</u></a></li>\r\n            </ul> \r\n          \r\n        </nav>\r\n\r\n  </div> \r\n  <div class=\"row\">-->\r\n    <div class=\"row panel panel-default\" style=\"max-width:750px;margin-left:20px;margin-right:20px;margin-top:-260px;\">\r\n      <div class=\"row\">\r\n        <div class=\"col-xs-12 col align-self-start\" style=\"margin-left:10px;margin-top:0px\">\r\n          <span class=\"font-weight-bold \" style=\"font-style: normal;font-size: 8pt \">@evelyngrant</span>\r\n          <span style=\"margin-right:10px;float:right; font-style: normal;font-size: 8pt;color:#aaaa\">3:04 pm </span>\r\n          <br>\r\n          <span class=\"font-weight-normal \" style=\"font-style: normal;font-size: 8pt;color:#aaaa\">Nam dapibus ni.</span>\r\n        </div>\r\n      </div>\r\n      <div class=\"row\">\r\n        <div class=\"col-xs-12 col align-self-center img-with-text\">\r\n          <img src=\"assets/images/feed.png\" style=\"height:100px;width:80px;background-repeat:\r\n        no-repeat;margin-left:10px;\" alt=\"Delivered\" />\r\n          <p style=\"margin-left:10px; text-align:left;font-style: normal;font-size: 8pt;color:#aaaa\">Delivered</p>\r\n        </div>\r\n      </div>\r\n      <div class=\"row \" style=\"margin-top:10px;margin-bottom:10px;\">\r\n        <div class=\"col-xs-12 align-self-end\">\r\n          <a style='float:left;margin: 0 15px 0 15px;height: 20px;width: 20px;' role=\"button\" class=\"collapsed\" href=\"#collapsePayment\"\r\n            data-parent=\"#accordion\" data-toggle=\"collapse\" aria-expanded=\"true\" attr.aria-controls=\"#collapsePayment\">\r\n            <span class=\"glyphicon pull-right glyphicon-chevron-right\" style=\"padding: 10px;background-color: #cccc;\"></span>\r\n          </a>\r\n          <input type=\"text\" class=\"form-control\" id=\"exampleFormControlInput1\" placeholder=\"Comment\" style=\"float:left;width:70%\">\r\n        </div>\r\n      </div>\r\n    </div>\r\n  <!--</div>\r\n   <div class=\"row\">\r\n      <nav class=\"navbar\" style=\"margin-right:10px;float:right;margin-top:-25px;\">\r\n          <ul class=\"nav navbar-nav\" style=\"margin-right:-10px;float:right;margin-top:0px;\">\r\n              <li><a class ='btn'  (click)='viewAlert()' style=\"margin-right:-5px;float:right; font-style: normal;font-size: 8pt;margin-top:-20px;\"><i   (click)='newfeed()' style=\"cursor: pointer\"></i><br /> <u>View Inbox</u></a></li>\r\n          </ul> \r\n        \r\n      </nav>\r\n      <a style=\"margin-right:10px;float:right; font-style: normal;font-size: 8pt;margin-top:0px;\">\r\n        <u>View Inbox</u>\r\n      </a> \r\n    </div> \r\n</div>-->\r\n"
...
module.exports = "<!-- <div class=\"container\" style=\"max-width:700px;margin-left:10px;margin-top:-290px;margin-right:10px;margin-bottom: 10px;border-color: #f8f8f8\"> -->\r\n <div class=\"row panel panel-default\" style=\"max-width:750px;margin-left:20px;margin-right:20px;margin-top:-260px;\">\r\n  <div class=\"row\" style=\"margin-top:10px\">\r\n    <p style=\"margin-left:20px; text-align:left;font-style: normal;font-size: 8pt;color:#aaaa\">\r\n      @evelyngrant\r\n      <span style=\"margin-right:20px; float:right; font-style: normal;font-size: 8pt\">08 May 8:52 am </span>\r\n    </p>\r\n    <p style=\"margin-left:20px; text-align:left;font-style: normal;font-size: 10pt\">\r\n      Curabitor lab.\r\n    </p>\r\n    <hr>\r\n    <p style=\"margin-left:20px; text-align:left;font-style: normal;font-size: 8pt;color:#aaaa\">\r\n      @evelyngrant\r\n      <span style=\"margin-right:20px; float:right; font-style: normal;font-size: 8pt\">08 May 8:52 am </span>\r\n    </p>\r\n    <p style=\"margin-left:20px; text-align:left;font-style: normal;font-size: 10pt\">\r\n      Vestibulum rutrum quam...\r\n    </p>\r\n    <hr>\r\n    <p style=\"margin-left:20px; text-align:left;font-style: normal;font-size: 8pt;color:#aaaa\">\r\n      @helnkim\r\n      <span style=\"margin-right:20px; float:right; font-style: normal;font-size: 8pt\">10 May 9:52 pm </span>\r\n    </p>\r\n    <p style=\"margin-left:20px; text-align:left;font-style: normal;font-size: 10pt\">\r\n      saw this trend.\r\n    </p>\r\n\r\n  </div>\r\n</div>"
...
var MainComponent = (function () {
    function MainComponent(_router, httpclient, sanitizer) {
        this._router = _router;
        this.httpclient = httpclient;
        this.sanitizer = sanitizer;
        this.url = "https://pnrstage.ic3.com:4443/mobileApp/";
        // this.createTableauToken();
    }
    MainComponent.prototype.ngOnInit = function () {
        this.visualizations = [
            new vizItem('https://sw730dpdtda001.corpdev.visa.com/t/MMR/views/PrimariesMapv2_0Mobile/Mobile?:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no', '2'),
            new vizItem('https://sw730dpdtda001.corpdev.visa.com/t/MMR/views/PrimariesMapv2_0Mobile/Mobile?:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no', '1')
        ];
        //   let baseAddress = 'https://pnrstage.ic3.com:4443/mobileApp/'
        //   let embeddedAnalytics = 'embeddedAnalytics/trusted/';
        //  //let postTablueaUIcontext = '?:embed=n&:linktarget=_parent&:embed=y&:showVizHome=n&:apiID=host0';
        //     let embeddedAnalyticsReportsPath='/t/MMR/views/SampleMerchantAggregatedAccountInsights20170822/Title';
        //   let tabticket='dnfzRDiwR8-6y-Q9upJIGw==:oBXvt57qtEw56dUMQ6Pgv4bw';
        //   //this.vizUrl = "https://pnrstage.ic3.com:4443/mobileapp/" + embeddedAnalytics + this.tabticket + this.embeddedAnalyticsReportsPath + postTablueaUIcontext;
        //   let vizUrl = "https://pnrstage.ic3.com:4443/mobileapp/" + embeddedAnalytics + tabticket + embeddedAnalyticsReportsPath;//+ postTablueaUIcontext;
        //   const optionsOne = {
        //     hideTabs: false,
        //     width: "100%",
        //     height: "1000px",
        ...
        //     }
        //   };
        //   new tableau.Viz(document.getElementById('vizContainer'), this.vizUrl, optionsOne);
        //this.getFoods();
        //   this.visualizations = [  
        //   new vizItem(vizUrl,'2') 
    ...
    MainComponent.prototype.createTableauToken = function () {
        var postTablueaUIcontext = '?:embed=n&:linktarget=_parent';
        var embeddedAnalytics = 'embeddedAnalytics/trusted/';
        //   let embeddedAnalytics = 'embeddedAnalytics/trusted/';
        //  let postTablueaUIcontext = '?:embed=n&:linktarget=_parent&:embed=y&:showVizHome=n&:apiID=host0';
        var embeddedAnalyticsReportsPath = '/t/MMR/views/SampleMerchantAggregatedAccountInsights20170822/Title';
        var tabticket = '7vvPZ45ZSz-08p6tXBzCwg==:lRav9JfBDPWhsGiffOqn6Lud';
        this.url = "https://pnrstage.ic3.com:4443/mobileapp/" + embeddedAnalytics + tabticket + embeddedAnalyticsReportsPath;
        this.urlSafe = this.sanitizer.bypassSecurityTrustResourceUrl(this.url);
    };
    MainComponent.prototype.getFoods = function () {
        // return this.httpclient.get('http://localhost:12838/api/values');
        var resp;
        this.httpclient.get('http://localhost:12838/api/values')
            .subscribe(function (result) {
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["D" /* Input */])(),
        __metadata("design:type", String)
    ], MainComponent.prototype, "vizUrl", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["D" /* Input */])(),
        __metadata("design:type", String)
    ], MainComponent.prototype, "comments", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["D" /* Input */])(),
        __metadata("design:type", String)
    ], MainComponent.prototype, "url", void 0);
    MainComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__angular_router__["b" /* Router */], __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["a" /* HttpClient */], __WEBPACK_IMPORTED_MODULE_3__angular_platform_browser__["b" /* DomSanitizer */]])
    ], MainComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__modules_analytics_v1_components_inbox_tableauinbox_component__ = __webpack_require__("./src/app/modules/analytics/v1/components/inbox/tableauinbox.component.ts");
    ...
    SharedComponentModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["J" /* NgModule */])({
            ...
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_17__modules_analytics_v1_components_inbox_tableauinbox_component__["a" /* TableauInboxComponent */],
